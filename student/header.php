           ...
           <div class="header-section hidden-xs" id="notice-headerbox">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        ...
                        <div class="user-info">
                            <span class="user-name"><?=$student_info['fname']?></span>
                    ...
                    <div class="nano-content">
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                                ...
                                <li class="<?=$page =='book.php'?'active-iteam':''?>"><a href="book.php"><i class="fa fa-book" aria-hidden="true"></i><span>Books</span></a></li>
                                <!--UI ELEMENTENTS-->
